...
import { Eye, Award, Zap, ShieldCheck, type LucideIcon } from "lucide-react";

const ICONS: LucideIcon[] = [Eye, Award, Zap, ShieldCheck];
          ...
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-soft transition-all duration-200 hover:-translate-y-1 hover:shadow-premium"
              >
                <div
