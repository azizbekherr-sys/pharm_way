...
export default function TestimonialsHero() {
  const t = useTranslations("testimonialsPage.hero");
  ...
  return (
    <section className="relative overflow-hidden bg-primary-700 pb-16 pt-32 sm:pb-20 sm:pt-40">
      <svg className="pointer-events-none absolute inset-0 h-full w-full opacity-[0.07]" aria-hidden="true">
        <defs>
          <pattern id="pharma-pattern-testimonials" width="84" height="84" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#pharma-pattern-testimonials)" />
      </svg>
